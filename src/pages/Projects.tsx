...
const Projects = () => {
  ...
  return (
    <div className="pt-24">
      ...
      <section className="py-20 mt-20 bg-gradient-royal/5">
        <div className="section-container">
          <div className="text-center mb-16">
            ...
            />
            <AnimatedText
              text="How We Deliver Your Project"
              className="text-3xl md:text-4xl font-bold tracking-tight mb-6"
              tag="h2"
              delay={200}
            />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="bg-white/80 backdrop-blur-md border border-white/40 shadow-md animate-on-scroll opacity-0" style={{animationDelay: "0.2s"}}>
              <CardContent className="p-6">
                <div className="h-14 w-14 rounded-full bg-gradient-royal/10 flex items-center justify-center mb-6">
            ...
            <Card className="bg-white/80 backdrop-blur-md border border-white/40 shadow-md animate-on-scroll opacity-0" style={{animationDelay: "0.4s"}}>
              <CardContent className="p-6">
                <div className="h-14 w-14 rounded-full bg-gradient-royal/10 flex items-center justify-center mb-6">
      ...
      <section className="py-20">
        <div className="section-container">
          <div className="text-center mb-16">
            ...
            />
            <AnimatedText
              text="How We Create Your Website"
              className="text-3xl md:text-4xl font-bold tracking-tight mb-6"
              tag="h2"
              delay={200}
            />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl h-80 animate-on-scroll opacity-0" style={{animationDelay: "0.2s"}}>
              <img 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mt-20">
            <div className="relative rounded-2xl overflow-hidden shadow-xl h-80 md:order-1 order-2 animate-on-scroll opacity-0" style={{animationDelay: "0.4s"}}>
              <img 
            ...
            <div className="md:order-2 order-1 animate-on-scroll opacity-0" style={{animationDelay: "0.2s"}}>
      ...
      <section className="py-20 bg-gradient-royal/5">
        <div className="section-container">
          <div className="text-center mb-16">
            ...
            />
            <AnimatedText
              text="Launch Your Website With Ease"
              className="text-3xl md:text-4xl font-bold tracking-tight mb-6"
              tag="h2"
              delay={200}
            />
