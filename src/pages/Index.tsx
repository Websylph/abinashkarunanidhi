...
const Index = () => {
  ...
  return <div className="pt-16">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-20">
        ...
        <div className="section-container relative z-10">
          <div ref={heroRef} className="max-w-3xl mx-auto text-center opacity-0">
            ...
            <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">I blend elegant design with cutting-edge technology to create memorable user experiences that elevate brands and solve real problems and Make Your Digital Presence </p>
      ...
      <section className="py-16 bg-primary/5">
        <div className="section-container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8" ref={statsRef}>
            {stats.map((stat, index) => <div key={index} className="text-center opacity-0" style={{
      ...
      <section className="py-20 bg-secondary/30">
        <div className="section-container">
          <div className="text-center mb-16">
            <AnimatedText text="What I Do" className="text-sm font-medium px-3 py-1 bg-primary/5 text-primary/80 rounded-full inline-block mb-4" tag="span" />
            <AnimatedText text="Transforming Ideas into Digital Reality" className="text-3xl md:text-4xl font-bold tracking-tight" tag="h2" delay={200} />
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <SkillCard icon={<Code className="text-primary" size={24} />} title="Web Development" description="Building responsive, performant websites with modern frameworks and clean code principles." delay={100} />
            <SkillCard icon={<Palette className="text-primary" size={24} />} title="UI/UX Design" description="Creating intuitive, beautiful interfaces focused on user experience and conversion." delay={200} />
            <SkillCard icon={<Database className="text-primary" size={24} />} title="Backend Solutions" description="Developing robust backend systems with secure APIs and efficient database architecture." delay={300} />
            <SkillCard icon={<Sparkles className="text-primary" size={24} />} title="Creative Solutions" description="Solving complex problems with innovative approaches and creative thinking." delay={400} />
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="section-container">
          <div className="text-center mb-16">
            <AnimatedText text="SaaS Products" className="text-sm font-medium px-3 py-1 bg-primary/5 text-primary/80 rounded-full inline-block mb-4" tag="span" />
            <AnimatedText text="Digital Solutions for Growth" className="text-3xl md:text-4xl font-bold tracking-tight" tag="h2" delay={200} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {saasProducts.map((product, index) => <Card key={index} className="overflow-hidden transition-all duration-300 hover:shadow-lg opacity-0 border border-border/50" style={{
            animation: 'fade-in-up 0.6s ease-out forwards ' + (index * 0.1 + 0.3) + 's'
          }}>
                ...
                <CardContent className="p-6">
                  ...
                  <a href={product.url} target="_blank" rel="noopener noreferrer" className="text-primary font-medium inline-flex items-center hover:underline group">
                    View Product
      ...
      <section className="py-20 bg-secondary/10">
        <div className="section-container">
          <div className="text-center mb-16">
            <AnimatedText text="Featured Work" className="text-sm font-medium px-3 py-1 bg-primary/5 text-primary/80 rounded-full inline-block mb-4" tag="span" />
            <AnimatedText text="Recent Projects I'm Proud Of" className="text-3xl md:text-4xl font-bold tracking-tight" tag="h2" delay={200} />
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="overflow-hidden transition-all duration-300 hover:shadow-lg opacity-0" style={{
        ...
        <div className="section-container">
          <div className="bg-primary/5 rounded-2xl p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl">
              <AnimatedText text="Interested in working together?" className="text-2xl md:text-3xl font-bold mb-4" tag="h2" />
              <AnimatedText text="I'm always open to discussing new projects, creative ideas or opportunities to be part of your vision." className="text-muted-foreground mb-8" tag="p" delay={200} />
