...
const Index = () => {
  ...
  return (
    <div className="pt-12 sm:pt-14 md:pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            >
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="flex justify-between items-start mb-3 sm:mb-4">
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">Growify Platform</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">A comprehensive growth platform with analytics and business solutions.</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 mt-3 sm:mt-4">
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="section-container">
          <div className="bg-primary/5 rounded-2xl p-6 sm:p-8 md:p-12 relative overflow-hidden">
